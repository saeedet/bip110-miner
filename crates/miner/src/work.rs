...
mod tests {
    ...
    /// The distinction that caused a real bug in the sibling project.
    ///
    ...
    ///
    /// The observed symptom there was throughput collapsing from 95 blocks in
    /// eight seconds to 3, with the cores busy and doing nothing.
    #[test]
