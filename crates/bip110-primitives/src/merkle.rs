...
///
/// Both children go in as internal-order bytes, which is why [`Hash256`]
...
/// txid *is* the root.
pub fn coinbase_branch(leaves: &[Hash256]) -> Vec<Hash256> {
...
pub fn root_from_coinbase_branch(coinbase: Hash256, branch: &[Hash256]) -> Hash256 {
